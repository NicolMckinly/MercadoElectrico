...
Genera el grafico de LINEA del IMAR y el PB Proyectado TMM, periodo
a periodo, para el dia siguiente. Se usa dentro del informe diario,
...
def generar_grafico_imar_siguiente_dia(tabla_imar):
    """
    Genera el grafico de linea del IMAR vs PB Proyectado TMM, periodo
    a periodo, a partir del diccionario ya calculado por
    obtener_tabla_imar_siguiente_dia() (en Analisis/tabla_imar_siguiente_dia.py).

    Parametros:
        tabla_imar (dict o None): debe tener la forma
            {"fecha": ..., "filas": [{"periodo": ..., "imar_crudo": ..., "pb_proyectado": ...}, ...]}
    ...
    valores_proyectado = [f["pb_proyectado"] for f in tabla_imar["filas"]]
    ...
    ejes.plot(posiciones, valores_proyectado, marker="o", markersize=4,
              linewidth=2, label="PB Proyectado TMM", color=COLOR_PB_PROYECTADO)
...
if __name__ == "__main__":
    ...
    tabla_prueba = {
        "fecha": "2026-07-09",
        "filas": [
            {"periodo": "00:00-01:00", "imar_crudo": 350.0, "pb_proyectado": 360.0},
            {"periodo": "01:00-02:00", "imar_crudo": 340.0, "pb_proyectado": 345.0},
            {"periodo": "02:00-03:00", "imar_crudo": 330.0, "pb_proyectado": 335.0},
        ]
    }
